            ...
            <div className='crowd-page'>
                ...
                <div className="quota-box">
                    ...
                    <div className="join-input">
                        <Input className='input' type='number' placeholder='输入参与最大额度（100起）' />
                ...
                </div>
                {
                    [1, 2, 3, 4].map((crowd, index) => {
                        ...
                        return (
                            <div className={`crowd-data ${isSuccess ? 'success' : 'error'} `} key={index}>
                ...
                <div className='crowd-rule'>
                    ...
                    <div className='rule-text'>3.未参与成功的代币金额将退回到预约资金池</div>
                    <div className='rule-text'>4.众筹成功，参与者将获得10%的静态收益</div>
                    <div className='rule-text'>5.众筹失败，请<span className='link'>查看详细规则</span></div>
                </div>
            </div>
        </>
    )
